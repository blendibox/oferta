...
<br/>
		  {(offer || price) && <div className={styles.grid}> Preço na data do post:  <b>{offer || price}*</b></div>}
...
Se essa dica te <b>poupou tempo</b>, te ajudou a <b>decidir</b>, e evitou dor de cabeça… É hora da etapa que eu mais amo💗! <br/>Compre clicando neste link abaixo: ✨💗</p>
			  ...
			  <address aria-label="Data da publicação">
	            <time dateTime="2025-06-28">*Junho 28, 2025 por Juliana Costa</time>
          </address>
