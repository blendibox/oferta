    ...
    >
      ...
      <nav className="ampstart-sidebar-nav ampstart-nav">
        <ul className="list-reset m0 p0 ampstart-label">
           <li className="ampstart-nav-item">
            <Link className="ampstart-nav-link" href="https://comprar.blendibox.com.br">Início</Link>
          </li>
         <li className="ampstart-nav-item">
            <Link className="ampstart-nav-link" href="https://comprar.blendibox.com.br/cupons">Cupons de DESCONTO</Link>
          </li>
          <li className="ampstart-nav-item">
            <Link className="ampstart-nav-link" href="https://comprar.blendibox.com.br/cupons/beleza">Cupons Beleza e Perfumaria</Link>
          </li>
          <li className="ampstart-nav-item">
            <Link className="ampstart-nav-link" href="https://comprar.blendibox.com.br/cupons/girafa">Cupons Eletrônicos</Link>
          </li>
                      ...
                      return (
                        <li key={cat.url} className="ampstart-dropdown-item" >
                          <Link href={`${cat.url}`} as={`${cat.url}`} >
                            <Link  className="text-decoration-none" >{cat.title}</Link>
                          </Link>
                        </li>
                      );
                    })}
          ...
          <li className="ampstart-nav-item">
            <Link className="ampstart-nav-link" href="https://www.blendibox.com.br">Comprar Produtos Avon</Link>
          </li>

          <li className="ampstart-nav-item">
            <Link className="ampstart-nav-link" href="https://www.avon.com.br/institucional/seja-representante/cadastro?codigo-self-appointment=74806588">Revender produtos Avon</Link>
          </li>
      ...
      <ul className="ampstart-sidebar-faq list-reset m0">
        <li className="ampstart-faq-item">
          <Link href="https://www.blendibox.com.br" className="text-decoration-none">Sobre</Link>
          <Link href="https://www.blendibox.com.br">
              <Link className="flex flex-initial items-center font-bold md:mr-24">
